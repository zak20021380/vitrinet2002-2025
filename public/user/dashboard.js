  ...
  `;
    ...
    const missionData = {
      ...
      explore: {
        ...
        desc: 'کافیه ۹۰ ثانیه توی بازارچه محصولات رو نگاه کنی تا ۲۰۰ تومان جایزه بگیری!',
        primaryBtn: {
      ...
      if (recentTransactions && walletData.recentTransactions) {
        if (walletData.recentTransactions.length === 0) {
          ...
          recentTransactions.innerHTML = walletData.recentTransactions.map(t => {
            ...
            // فرمت تاریخ
            const dateStr = t.createdAt ? formatTransactionDate(t.createdAt) : '';
              ...
              <div class="wallet-transaction">
                <div class="wallet-transaction-info">
                  ...
                  <div class="wallet-transaction-details">
                    ...
                    ${dateStr ? `<span class="wallet-transaction-date">${dateStr}</span>` : ''}
                  </div>
                </div>
