(() => {
  ...
  const tierDescriptions = {
    normal: 'نمایش استاندارد در بخش فروشگاه‌های مشابه، بعد از پلن‌های ویژه',
    priority: 'نمایش در جایگاه‌های بالاتر و پربازدیدتر بخش فروشگاه‌های مشابه'
  };
  ...
  function openGuideModal(plan) {
    ...
    if (factsEl) {
      factsEl.innerHTML = `
        ...
        <div class="ssw-guide-fact">
          <span>مزیت اصلی</span>
          <strong>${plan.tier === 'priority' ? 'جایگاه بالاتر و پربازدیدتر' : 'نمایش استاندارد بعد از پلن‌های ویژه'}</strong>
        </div>
        <div class="ssw-guide-fact">
          <span>مدل نمایش</span>
