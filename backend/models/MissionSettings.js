...
missionSettingSchema.statics.getDefaults = function() {
  return [
    ...
    { missionId: 'user-first-purchase', category: 'users', title: 'اولین خرید', description: 'پاداش برای انجام اولین خرید', amount: 20000, isActive: false, icon: 'ri-shopping-bag-line', cardStyle: 'booking', order: 5 },
    { missionId: 'user-review', category: 'users', title: 'ثبت نظر', description: 'پاداش برای ثبت نظر روی محصولات', amount: 2000, isActive: false, icon: 'ri-chat-quote-line', cardStyle: 'explore', order: 6 },
